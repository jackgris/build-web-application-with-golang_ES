# 13.5 Agregar, eliminar y actualizar blogs

Introducido en el marco beego delante para lograr el concepto general y la aplicación parcial de la pseudo-código, que subsecciones describen a través beego construir un sistema de blog, incluyendo hojee, agregar, modificar o eliminar la operación. modify, or delete operation.

## Directorio de blogs

Directorios de blog son los siguientes:
...
## Blog de enrutamiento

Blog principales reglas de enrutamiento son los siguientes:
	//Show blog Home
...
La información de base de datos más fácil de diseño del blog
