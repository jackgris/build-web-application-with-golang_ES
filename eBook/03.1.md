...
Este es un sencillo flujo de trabajo de asuntos HTTP , observe que cada servidor de tiempo cierra las conexiones después de datos que se envían a los clientes, y espera a que la próxima petición.
...
sede de IP o nombre de dominio del servidor HTTP
...
Anfitrión: www.iana.org / / nombre de dominio
...
Figura 3.5 Información de método POST capturado por el violinista
...
Line HTTP/1.1 200 OK / / estado
Servidor : El software de servidor de nginx/1.0.8 / / web y su versión en el equipo servidor
Fecha: Fecha: Mar, 30 de octubre 2012 04:14:25 GMT / / tiempo respondió
Content-Type : text / html / / respondido tipo de datos
...
/ / Línea en blanco
< DOCTYPE HTML PUBLIC "- / / W3C / / DTD XHTML 1.0 Transitional / / EN" ... / cuerpo /mensaje
...
HTTP no tiene estado y conexion: keep-alive 
